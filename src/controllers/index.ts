...
import cityDataController from "./cityDataController";
import cityWeatherByCoordinatesController from "./cityWeatherByCoordinatesController";
import cityWeatherByNameController from "./cityWeatherByNameController";

export default {
  cityDataController,
  cityWeatherByCoordinatesController,
  cityWeatherByNameController
}