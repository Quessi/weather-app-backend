...
// import eventsApi from "../utils/Events/eventsAPI";
...
const cityDataController_1 = __importDefault(require("./cityDataController"));
const cityWeatherByCoordinatesController_1 = __importDefault(require("./cityWeatherByCoordinatesController"));
const cityWeatherByNameController_1 = __importDefault(require("./cityWeatherByNameController"));
exports.default = {
    cityDataController: cityDataController_1.default,
    cityWeatherByCoordinatesController: cityWeatherByCoordinatesController_1.default,
    cityWeatherByNameController: cityWeatherByNameController_1.default
};
